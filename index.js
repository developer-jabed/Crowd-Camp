...
// const uri = "mongodb+srv://crowdCampaign:X1Jvt6Cz3kg1xrHV@cluster0.xo1yp.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
...
app.get("/", (req, res) => {
  res.send("crowdfund server is running");
});
